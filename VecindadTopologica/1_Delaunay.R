...
comunas <- c(13102, 13118, 13123, 13201, 13401, 13604) # Comunas que fallan en vecindad
# comunas <- c(13201, 13401) # Comunas con una trama muy densa
...
vecs1 <- knn2nb(knearneigh(coords, k = 7), row.names = IDs) # 4 vecinos
plot(vecs1, coords)
...
lw <- nb2listw(vecs1) # Spatial Weights For Neighbours Lists
...
write.nb.gal(vecs1, glue("Output/weights_stgo_ismt_{comuna}.gal"), oldstyle=TRUE, shpfile=NULL, ind=NULL) # Guardar vecs1, sin recortar
